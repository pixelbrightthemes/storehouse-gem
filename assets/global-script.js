...
var _templatesuffix = document.getElementById("templatesuffix").value;
/**** Scroll To Top ***/
if (!Shopify.designMode) {
  
  if (_templatesuffix != "quickview") {
    
    var backtotopbutton = document.getElementById("backtotop_btn");
...
class MenuDrawer extends HTMLElement {
  ...
  openMenuDrawer(summaryElement) {
    ...
    document.body.classList.add(`overflow-x-hidden-${this.dataset.breakpoint}`);
  }
  ...
  closeMenuDrawer(event, elementToFocus = false) {
    ...
    document.body.classList.remove(`overflow-x-hidden-${this.dataset.breakpoint}`);
